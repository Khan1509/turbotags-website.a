    ...
    <section className="bg-white p-6 rounded-xl shadow-md">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {platformData.map((platform, index) => (
          <motion.div 
            key={platform.name} 
            className="platform-card bg-gray-50 rounded-lg p-6 text-center border border-gray-200"
            whileHover={{ y: -8, scale: 1.05, boxShadow: "0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)" }}
