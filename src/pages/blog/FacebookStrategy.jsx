...
const FacebookStrategy = () => {
  return (
    <main className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md my-8">
      <article>
        <img src="https://img-wrapper.vercel.app/image?url=https://images.unsplash.com/photo-1556155092-490a1ba16284?w=800&h=400&fit=crop" alt="Facebook Hashtag Strategy" className="w-full h-auto object-cover rounded-lg mb-6" />
