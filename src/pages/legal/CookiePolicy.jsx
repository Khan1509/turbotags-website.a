  ...
  return (
    <main className="container mx-auto max-w-4xl p-8">
      <div className="bg-white p-8 rounded-xl shadow-lg">
        <h1 className="text-4xl font-bold text-tt-dark-violet mb-4">Cookie Policy</h1>
        <p className="text-gray-500 mb-8">Last updated: July 11, 2025</p>
        
        <div className="space-y-6 text-gray-700">
          <h2 className="text-2xl font-bold text-tt-dark-violet pt-4">What Are Cookies</h2>
          ...
          <h2 className="text-2xl font-bold text-tt-dark-violet pt-4">How We Use Cookies</h2>
          <p>We use cookies for a variety of reasons detailed below. Unfortunately, in most cases, there are no industry standard options for disabling cookies without completely disabling the functionality and features they add to this site. It is recommended that you leave on all cookies if you are not sure whether you need them or not in case they are used to provide a service that you use.</p>

          <h2 className="text-2xl font-bold text-tt-dark-violet pt-4">Disabling Cookies</h2>
