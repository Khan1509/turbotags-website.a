    ...
    <main className="container mx-auto max-w-4xl p-6 py-10">
      <div className="bg-white p-8 rounded-xl shadow-lg">
        <div className="text-center border-b pb-4 mb-8">
            ...
            <h1 className="text-4xl font-bold mb-2" style={{color: '#475569'}}>Terms of Service</h1>
            <p className="text-gray-500">Last updated: July 11, 2025</p>
        </div>
        
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>3. User Conduct and Responsibilities</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>4. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>6. Termination</h2>
            <p>We may terminate or suspend access to our Service immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-3" style={{color: '#475569'}}>7. Changes to Terms</h2>
